...
void FUN_140082140(longlong param_1,undefined8 param_2)

{
  ...
  FUN_1405bba90(param_2,param_1 + 0x58,2);
  FUN_1405bba90(param_2,param_1 + 0x5a,2);
  FUN_1405bba90(param_2,param_1 + 0x5c,2);
