// FUN_1405bd110 @ 1405bd110
// callees:
//   -> 140157f80 FUN_140157f80


void FUN_1405bd110(longlong param_1,short param_2,short param_3,short param_4)

{
  ...
  if (((((-1 < param_2) && ((int)param_2 < *(int *)(param_1 + 0x1160e4))) && (-1 < param_3)) &&
    ...
    FUN_140157f80(lVar1,uVar3 & 0xffff,uVar2);
    return;
  }
  return;
}
