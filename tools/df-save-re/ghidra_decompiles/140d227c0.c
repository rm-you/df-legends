// FUN_140d227c0 @ 140d227c0
// callees:


void FUN_140d227c0(longlong param_1,short param_2,short param_3,short param_4,uint param_5)

{
  ...
  if (((((-1 < param_2) && ((int)param_2 < *(int *)(param_1 + 0x1160e4))) && (-1 < param_3)) &&
    ...
    puVar1[(longlong)(int)uVar3 * 0x10 + (longlong)(int)uVar2 + 0x1a5] =
         puVar1[(longlong)(int)uVar3 * 0x10 + (longlong)(int)uVar2 + 0x1a5] | param_5;
    if ((DAT_1410b67dc == 0) && ((param_5 & 0x3c0000) != 0)) {
      *puVar1 = *puVar1 | 1;
      puVar1[0x12] = 0;
    }
  }
