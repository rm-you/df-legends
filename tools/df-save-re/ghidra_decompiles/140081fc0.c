...
void FUN_140081fc0(longlong param_1,undefined8 param_2)

{
  ...
  FUN_1405bb7c0(param_2,local_res8,4);
  local_res8[0]._0_2_ = *(undefined2 *)(param_1 + 0x58);
  FUN_1405bb7c0(param_2,local_res8,2);
  local_res8[0]._0_2_ = *(undefined2 *)(param_1 + 0x5a);
  FUN_1405bb7c0(param_2,local_res8,2);
