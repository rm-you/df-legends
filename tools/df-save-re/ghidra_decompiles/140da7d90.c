// FUN_140da7d90 @ 140da7d90
// callees:
//   -> 140150c40 FUN_140150c40


undefined8 FUN_140da7d90(longlong param_1,short param_2,short param_3,short param_4)

{
  ...
  if (((((-1 < param_2) && ((int)param_2 < *(int *)(param_1 + 0x1160e4))) && (-1 < param_3)) &&
    ...
    uVar2 = FUN_140150c40(lVar1,uVar4 & 0xffff,uVar3);
    return uVar2;
  }
  return 0;
}
