...
void FUN_14075f020(longlong param_1,undefined4 param_2)

{
  ...
  if (-1 < sVar1) {
    if ((((ulonglong)(longlong)sVar1 < (ulonglong)(DAT_141d6dd58 - DAT_141d6dd50 >> 3)) &&
      ...
      FUN_140d9ead0(plVar3,param_1 + 0x38,9,*(undefined4 *)(param_1 + 0xa4),plVar3);
      return;
    }
  }
  lVar2 = FUN_140752d70(param_1);
  if ((lVar2 != 0) && (*(longlong *)(*(longlong *)(lVar2 + 8) + 0x3c0) != 0)) {
    FUN_1404c59d0(lVar2,param_1 + 0x38);
    return;
  }
  FUN_14061e7d0(param_1 + 0x38,param_2,9,&DAT_141d6e1f0,&DAT_141d72d50);
  return;
}
