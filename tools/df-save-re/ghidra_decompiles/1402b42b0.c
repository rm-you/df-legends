...
void FUN_1402b42b0(ulonglong *param_1,longlong *param_2)
          ...
          if (puVar5[iVar8] == '[') {
            ...
            if (local_90 != 0) {
              ...
              if ((ulonglong)(longlong)iVar8 <= local_90) {
                ...
                if (local_70 != 0) {
                  iVar4 = FUN_14000c110(&local_80,"CREATURE_VARIATION");
                  if (iVar4 != 0) {
                    if (puVar6 != (undefined8 *)0x0) {
                      local_d8 = &local_b0;
                      cVar3 = FUN_1402b3b00(puVar6,&local_80,&local_c8);
                      if (cVar3 != '\0') {
                        if (0xf < local_68) {
                      ...
                      FUN_14007b5f0(local_60,puVar6,&DAT_140e7aaf8);
                      FUN_14000c9f0(local_60,"Unrecognized Creature Variation Token: ",0x27);
...
LAB_1402b46cf:
                    if (0xf < uVar11) {
                      FUN_140002020(CONCAT71(uStack_7f,local_80),uVar11 + 1,1);
                    }
                    goto LAB_1402b46f3;
                  }
                  _Memory = operator_new(200);
                  _Memory[3] = 0xf;
                  _Memory[2] = 0;
                  puVar6 = _Memory;
