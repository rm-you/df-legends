// FUN_140d431b0 @ 140d431b0
// callees:
//   -> 1401529c0 FUN_1401529c0


void FUN_140d431b0(longlong param_1,short param_2,short param_3,short param_4,undefined1 param_5)

{
  ...
  if (((((-1 < param_2) && ((int)param_2 < *(int *)(param_1 + 0x1160e4))) && (-1 < param_3)) &&
    ...
    FUN_1401529c0(lVar1,uVar3 & 0xffff,uVar2,param_5);
    return;
  }
  return;
}
