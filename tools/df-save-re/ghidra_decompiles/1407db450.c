...
void FUN_1407db450(longlong *param_1,ulonglong *param_2)

{
  ...
  if (param_1[1] - *param_1 >> 3 != 0) {
    do {
      uVar6 = 0;
      lVar1 = *(longlong *)(uVar8 + *param_1);
      if ((0 < *(int *)(lVar1 + 0x48)) && ((**(byte **)(lVar1 + 0x40) & 1) != 0)) {
        puVar4 = operator_new(0x18);
        *puVar4 = 0;
        puVar4[1] = 0;
        puVar4[2] = 0;
        local_78 = puVar4;
        FUN_140051cf0(puVar4,"interaction_layer");
        FUN_140051cf0(puVar4,"[OBJECT:INTERACTION]");
        local_50 = 0xf;
        local_58 = 0;
        local_68 = 0;
        FUN_14000c780(&local_68,"[INTERACTION:",0xd);
        FUN_14000cb40(&local_68,lVar1,0,0xffffffffffffffff);
        FUN_14000c9f0(&local_68,&DAT_140e7aafc,1);
        FUN_140051b70(puVar4,&local_68);
        uVar7 = uVar6;
        if (*(longlong *)(lVar1 + 0x30) - *(longlong *)(lVar1 + 0x28) >> 3 != 0) {
          do {
            FUN_140051b70(puVar4,*(undefined8 *)(uVar7 + *(longlong *)(lVar1 + 0x28)));
            uVar5 = (int)uVar6 + 1;
            uVar6 = (ulonglong)uVar5;
            uVar7 = uVar7 + 8;
          } while ((ulonglong)(longlong)(int)uVar5 <
                   (ulonglong)(*(longlong *)(lVar1 + 0x30) - *(longlong *)(lVar1 + 0x28) >> 3));
        }
    ...
    } while ((ulonglong)(longlong)(int)uVar5 < (ulonglong)(param_1[1] - *param_1 >> 3));
  }
  return;
}
