// FUN_14083df80 @ 14083df80
// callees:
//   -> 14083c020 FUN_14083c020
//   -> 140dfb6d8 operator_new
//   -> 140dfb5b4 free
//   -> 14083e140 FUN_14083e140


/* WARNING: Removing unreachable block (ram,0x00014083e0a2) */

undefined8 * FUN_14083df80(undefined8 *param_1)

{
  ...
  FUN_14083c020();
  *param_1 = itemdef_armorst::vftable;
  puVar1 = param_1 + 0xc;
  param_1[0xf] = 0xf;
  param_1[0xe] = 0;
  ...
  *(undefined4 *)((longlong)param_1 + 0x124) = 0xa000a;
  *(undefined2 *)(param_1 + 0x25) = 100;
  ...
  *(undefined4 *)((longlong)param_1 + 0x106) = 0;
  FUN_14083e140(param_1);
  return param_1;
}
