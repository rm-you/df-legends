...
void FUN_1402832f0(undefined8 *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  if (0xf < (ulonglong)param_1[0x27]) {
    FUN_140002020(*puVar1,param_1[0x27] + 1,1,param_4,0xfffffffffffffffe);
  }
  param_1[0x27] = 0xf;
  param_1[0x26] = 0;
  if (0xf < (ulonglong)param_1[0x27]) {
