...
ulonglong FUN_1400715b0(longlong param_1,ulonglong *param_2)

{
  ...
  uVar6 = iVar7 - 1;
  if (*(int *)(plVar10[(int)uVar6] + 0xe0) < iVar1) {
  ...
  if (-1 < (int)uVar6) {
    do {
      ...
      iVar2 = *(int *)(lVar11 + 0xe0);
      if (iVar2 == iVar1) {
        return 0xffffffff;
      }
      if (uVar9 == uVar6) {
        if (iVar2 < iVar1) goto LAB_140071774;
        if (iVar2 <= iVar1) {
          return 0xffffffff;
        }
  ...
  lVar11 = lVar4 * 8;
  if (*(int *)(plVar10[lVar4] + 0xe0) < iVar1) {
LAB_140071774:
    uVar9 = uVar9 + 1;
    if ((int)uVar9 < iVar7) {
      plVar10 = plVar10 + (int)uVar9;
LAB_140071789:
  ...
  else if (iVar1 < *(int *)(plVar10[lVar4] + 0xe0)) {
