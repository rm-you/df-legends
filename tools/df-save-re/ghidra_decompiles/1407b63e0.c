...
int * FUN_1407b63e0(longlong param_1,int param_2,undefined8 param_3)

{
  ...
  iVar8 = 0;
  iVar14 = 0;
  lVar5 = *(longlong *)(*(longlong *)(param_1 + 0x130) + 0x60);
  lVar11 = *(longlong *)(lVar5 + 0x18);
  iVar9 = (int)(*(longlong *)(lVar5 + 0x20) - lVar11 >> 3) + -1;
  if (-1 < iVar9) {
    do {
      iVar7 = iVar9 + iVar8 >> 1;
      piVar4 = *(int **)(lVar11 + (longlong)iVar7 * 8);
      iVar1 = *piVar4;
      if (iVar1 == param_2) {
        return piVar4;
      }
  ...
  *piVar4 = param_2;
  local_res20 = piVar4;
  FUN_1400b3ef0(piVar4,*(longlong *)(*(longlong *)(param_1 + 0x130) + 0x60) + 0x18);
  ...
  if ((lVar5 != 0) && (iVar9 = (int)lVar5 + -1, -1 < iVar9)) {
    do {
      ...
      if (*(int *)(lVar5 + 0xe0) == param_2) {
        ...
        if (lVar5 == 0) goto LAB_1407b6776;
        uVar10 = *(int *)(lVar5 + 0x24) - 1;
        if ((int)uVar10 < 0) goto LAB_1407b6758;
...
LAB_1407b66b0:
  ...
  if (*piVar6 == param_2) {
    ...
    FUN_1407b5cb0(lVar5,*(undefined2 *)(lVar13 + lVar5),piVar4 + 0x14);
...
LAB_1407b6776:
    FUN_1407b5980(param_1,piVar4 + 0x14,param_3);
    return piVar4;
  }
  uVar10 = uVar10 - 1;
  piVar6 = piVar6 + -1;
  lVar11 = lVar11 + -1;
  if (lVar11 < 0) goto LAB_1407b6758;
  goto LAB_1407b66b0;
}
