// FUN_14013c040 @ 14013c040
// callees:


ulonglong FUN_14013c040(longlong param_1,short param_2,short param_3,short param_4)
  ...
  if ((((param_2 < 0) || (*(int *)(param_1 + 0x1160e4) <= (int)param_2)) || (param_3 < 0)) ||
    ...
    if ((-1 < param_2) &&
      ...
      if (lVar1 != 0) {
        ...
        if ((int)param_4 + *(int *)(param_1 + 0x1160f8) < (int)sVar4) {
