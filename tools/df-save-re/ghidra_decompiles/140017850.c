// FUN_140017850 @ 140017850
// callees:


undefined8 * FUN_140017850(undefined8 *param_1)

{
  ...
  param_1[7] = 0;
  param_1[8] = 0;
  *param_1 = activity_event_make_believest::vftable;
  ...
  *(undefined2 *)((longlong)param_1 + 0xf2) = 0x8ad0;
  *(undefined4 *)((longlong)param_1 + 0xee) = 0x8ad08ad0;
  param_1[0x16] = 0;
