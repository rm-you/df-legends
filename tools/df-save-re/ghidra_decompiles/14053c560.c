...
void FUN_14053c560(longlong *param_1,ulonglong *param_2)

{
  ...
  if (param_1[1] - *param_1 >> 3 != 0) {
    do {
      ...
      if ((5 < *(int *)(lVar1 + 0x3a8)) &&
         ((*(byte *)(*(longlong *)(lVar1 + 0x3a0) + 5) & 0x10) != 0)) {
        puVar4 = operator_new(0x18);
        *puVar4 = 0;
        puVar4[1] = 0;
        puVar4[2] = 0;
        local_78 = puVar4;
        FUN_140051cf0(puVar4,"entity_layer");
        FUN_140051cf0(puVar4,"[OBJECT:ENTITY]");
        local_50 = 0xf;
        local_58 = 0;
        local_68 = 0;
        FUN_14000c780(&local_68,"[ENTITY:",8);
