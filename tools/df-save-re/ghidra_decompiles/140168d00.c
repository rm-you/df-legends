// FUN_140168d00 @ 140168d00
// callees:


void FUN_140168d00(longlong param_1,short param_2,short param_3,short param_4,undefined4 param_5)

{
  ...
  if (((((-1 < param_2) && ((int)param_2 < *(int *)(param_1 + 0x1160e4))) && (-1 < param_3)) &&
    ...
    *(undefined4 *)(lVar1 + 0xb94 + ((longlong)(int)uVar3 * 0x10 + (longlong)(int)uVar2) * 4) =
         param_5;
  }
  return;
}
