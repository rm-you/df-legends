...
ulonglong FUN_1401b3070(longlong param_1,ulonglong *param_2)

{
  ...
  uVar6 = iVar7 - 1;
  if (*(int *)(plVar10[(int)uVar6] + 0x50) < iVar1) {
  ...
  if (-1 < (int)uVar6) {
    do {
      ...
      if (uVar9 == uVar6) {
        if (iVar2 < iVar1) goto LAB_1401b322b;
        if (iVar2 <= iVar1) {
          return 0xffffffff;
        }
  ...
  lVar11 = lVar4 * 8;
  if (*(int *)(plVar10[lVar4] + 0x50) < iVar1) {
LAB_1401b322b:
    uVar9 = uVar9 + 1;
    if ((int)uVar9 < iVar7) {
      plVar10 = plVar10 + (int)uVar9;
LAB_1401b3240:
  ...
  else if (iVar1 < *(int *)(plVar10[lVar4] + 0x50)) {
