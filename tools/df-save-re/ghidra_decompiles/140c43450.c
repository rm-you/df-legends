// FUN_140c43450 @ 140c43450
// callees:
//   -> 140002020 FUN_140002020


void FUN_140c43450(longlong *param_1)

{
  ...
  lVar1 = param_1[0x21];
  if (lVar1 != 0) {
    FUN_140002020(lVar1,param_1[0x23] - lVar1 >> 2,4);
    param_1[0x21] = 0;
    param_1[0x22] = 0;
    param_1[0x23] = 0;
  }
  lVar1 = param_1[0x1e];
  if (lVar1 != 0) {
    FUN_140002020(lVar1,param_1[0x20] - lVar1 >> 2,4);
    param_1[0x1e] = 0;
    param_1[0x1f] = 0;
    param_1[0x20] = 0;
  }
  ...
  lVar1 = param_1[0x18];
  if (lVar1 != 0) {
    FUN_140002020(lVar1,param_1[0x1a] - lVar1 >> 1,2);
    param_1[0x18] = 0;
    param_1[0x19] = 0;
    param_1[0x1a] = 0;
  }
  lVar1 = param_1[0x15];
  if (lVar1 != 0) {
    FUN_140002020(lVar1,param_1[0x17] - lVar1 >> 1,2);
    param_1[0x15] = 0;
    param_1[0x16] = 0;
    param_1[0x17] = 0;
  }
  lVar1 = param_1[0x12];
  if (lVar1 != 0) {
    FUN_140002020(lVar1,param_1[0x14] - lVar1 >> 1,2);
    param_1[0x12] = 0;
    param_1[0x13] = 0;
    param_1[0x14] = 0;
  }
