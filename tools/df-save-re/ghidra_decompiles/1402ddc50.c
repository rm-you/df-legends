...
void FUN_1402ddc50(int *param_1,undefined2 param_2,longlong *param_3,undefined8 param_4)

{
  ...
  piVar6 = (int *)0x0;
  local_40 = (int *)0x0;
  iVar11 = (int)(param_3[1] - *param_3 >> 2);
  piVar8 = (int *)0x0;
  piVar10 = (int *)0x0;
  iVar1 = -1;
  while (iVar11 = iVar11 + -1, local_res18[0] = iVar11, -1 < iVar11) {
    lVar5 = FUN_140d89d60(&DAT_141c53470,param_2,*(undefined4 *)(*param_3 + (longlong)iVar11 * 4),
                          param_4,uVar13);
    if (lVar5 == 0) {
      iVar3 = 1;
    }
    ...
    if (((iVar3 < iVar1) || (iVar1 == -1)) ||
      ...
      piStack_48 = piVar2;
      if ((local_res18 < piVar7) && (piVar10 <= local_res18)) {
        lVar5 = (longlong)local_res18 - (longlong)piVar10;
        if (piVar7 == piVar6) {
