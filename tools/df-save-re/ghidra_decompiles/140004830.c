// FUN_140004830 @ 140004830
// callees:


undefined2 FUN_140004830(longlong param_1,short param_2,short param_3,short param_4)

{
  ...
  if (((((-1 < param_2) && ((int)param_2 < *(int *)(param_1 + 0x1160e4))) && (-1 < param_3)) &&
    ...
    return *(undefined2 *)(lVar1 + 0x92 + ((longlong)(int)uVar3 * 0x10 + (longlong)(int)uVar2) * 2);
  }
  return 0;
}
