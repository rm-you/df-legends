// FUN_140da8ec0 @ 140da8ec0
// callees:
//   -> 14015eda0 FUN_14015eda0


void FUN_140da8ec0(longlong param_1,short param_2,short param_3,short param_4)

{
  ...
  if (((((-1 < param_2) && ((int)param_2 < *(int *)(param_1 + 0x1160e4))) && (-1 < param_3)) &&
    ...
    FUN_14015eda0(lVar1,uVar3 & 0xffff,uVar2);
    return;
  }
  return;
}
