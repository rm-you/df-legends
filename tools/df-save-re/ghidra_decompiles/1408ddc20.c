...
void FUN_1408ddc20(longlong *param_1,ulonglong *param_2)

{
  ...
  if (param_1[1] - *param_1 >> 3 != 0) {
    do {
      ...
      if ((1 < *(int *)(lVar1 + 0x48)) && ((*(byte *)(*(longlong *)(lVar1 + 0x40) + 1) & 8) != 0)) {
        puVar4 = operator_new(0x18);
        *puVar4 = 0;
        puVar4[1] = 0;
        puVar4[2] = 0;
        local_78 = puVar4;
        FUN_140051cf0(puVar4,"plant_generated");
        FUN_140051cf0(puVar4,"[OBJECT:PLANT]");
        local_50 = 0xf;
        local_58 = 0;
        local_68 = 0;
        FUN_14000c780(&local_68,"[PLANT:",7);
