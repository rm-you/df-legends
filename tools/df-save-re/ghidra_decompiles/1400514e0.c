...
ulonglong FUN_1400514e0(longlong param_1,ulonglong *param_2)

{
  ...
  uVar6 = iVar7 - 1;
  if (*(int *)(plVar10[(int)uVar6] + 0x130) < iVar1) {
  ...
  if (-1 < (int)uVar6) {
    do {
      ...
      iVar2 = *(int *)(lVar11 + 0x130);
      if (iVar2 == iVar1) {
        return 0xffffffff;
      }
      if (uVar9 == uVar6) {
        if (iVar2 < iVar1) goto LAB_1400516a4;
        if (iVar2 <= iVar1) {
          return 0xffffffff;
        }
  ...
  lVar11 = lVar4 * 8;
  if (*(int *)(plVar10[lVar4] + 0x130) < iVar1) {
LAB_1400516a4:
    uVar9 = uVar9 + 1;
    if ((int)uVar9 < iVar7) {
      plVar10 = plVar10 + (int)uVar9;
LAB_1400516b9:
  ...
  else if (iVar1 < *(int *)(plVar10[lVar4] + 0x130)) {
