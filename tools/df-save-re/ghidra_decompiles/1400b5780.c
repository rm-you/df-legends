...
void FUN_1400b5780(longlong param_1,undefined8 param_2,int param_3)

{
  ...
  uVar4 = 0;
  uVar3 = (ulonglong)((longlong)*(undefined8 **)(param_1 + 0x10) + (7 - (longlong)puVar2)) >> 3;
