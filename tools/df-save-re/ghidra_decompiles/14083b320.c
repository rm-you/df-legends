// FUN_14083b320 @ 14083b320
// callees:
//   -> 140050410 FUN_140050410
//   -> 140050640 FUN_140050640


ulonglong FUN_14083b320(longlong param_1,ulonglong *param_2)

{
  ...
  uVar10 = iVar7 - 1;
  if (*(int *)(plVar4[(int)uVar10] + 0x1c) < iVar1) {
    if ((&local_res8 < plVar3) && (plVar4 <= &local_res8)) {
      if (plVar3 == (longlong *)param_2[2]) {
        FUN_140050410(param_2);
      }
  ...
  if (-1 < (int)uVar10) {
    do {
      ...
      if (uVar9 == uVar10) {
        if (iVar2 < iVar1) goto LAB_14083b515;
        if (iVar2 <= iVar1) {
          return 0xffffffff;
        }
        goto LAB_14083b51b;
  ...
  if (*(int *)(plVar4[(int)uVar9] + 0x1c) < iVar1) {
LAB_14083b515:
    uVar9 = uVar9 + 1;
    if ((int)uVar9 < iVar7) {
LAB_14083b51b:
    ...
    lVar5 = lVar11;
    if (iVar1 < *(int *)(plVar4[(int)uVar9] + 0x1c)) {
LAB_14083b522:
      FUN_140050640(param_2,local_res10,(longlong)plVar4 + lVar5,lVar11,&local_res8);
