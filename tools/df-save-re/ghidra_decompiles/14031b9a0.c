// FUN_14031b9a0 @ 14031b9a0
// callees:
//   -> 1403197e0 FUN_1403197e0
//   -> 1405bba90 FUN_1405bba90


void FUN_14031b9a0(longlong param_1,undefined8 param_2)
    ...
    if ((iVar2 != 0) && (local_res20[0] != -1)) {
      ...
      if (-1 < iVar2) {
        do {
          ...
          if (*(int *)(lVar4 + 0x130) == local_res20[0]) goto LAB_14031ba3c;
    ...
    if ((iVar2 != 0) && (local_res20[0] != -1)) {
      ...
      if (-1 < iVar2) {
        do {
          iVar1 = iVar3 + iVar2 >> 1;
          lVar4 = *(longlong *)(DAT_141c66fd0 + (longlong)iVar1 * 8);
          if (*(int *)(lVar4 + 0x130) == local_res20[0]) goto LAB_14031badc;
          if (local_res20[0] < *(int *)(lVar4 + 0x130)) {
            iVar2 = iVar1 + -1;
          }
          else {
...
LAB_14031badc:
  ...
  FUN_1405bba90(param_2,param_1 + 0x188,2);
  return;
}
