// FUN_1400c5d30 @ 1400c5d30
// callees:


void FUN_1400c5d30(longlong param_1,short param_2,short param_3,short param_4,undefined2 param_5)

{
  ...
  if (((((-1 < param_2) && ((int)param_2 < *(int *)(param_1 + 0x1160e4))) && (-1 < param_3)) &&
    ...
    *(undefined2 *)(lVar1 + 0x92 + ((longlong)(int)uVar3 * 0x10 + (longlong)(int)uVar2) * 2) =
         param_5;
  }
  return;
}
