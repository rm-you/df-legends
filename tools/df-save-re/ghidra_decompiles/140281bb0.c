...
void FUN_140281bb0(undefined8 *param_1)

{
  ...
  _eh_vector_destructor_iterator_(param_1 + 0xbd,0x20,6,FUN_14000c260);
  puVar3 = param_1 + 0xb9;
  if (0xf < (ulonglong)param_1[0xbc]) {
    FUN_140002020(*puVar3,param_1[0xbc] + 1,1);
  }
  param_1[0xbc] = 0xf;
  param_1[0xbb] = 0;
  if (0xf < (ulonglong)param_1[0xbc]) {
