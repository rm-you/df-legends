// FUN_1400c5df0 @ 1400c5df0
// callees:


void FUN_1400c5df0(longlong param_1,short param_2,short param_3,short param_4,uint param_5)

{
  ...
  if (((((-1 < param_2) && ((int)param_2 < *(int *)(param_1 + 0x1160e4))) && (-1 < param_3)) &&
    ...
    puVar1 = (uint *)(lVar2 + 0x294 + ((longlong)(int)uVar4 * 0x10 + (longlong)(int)uVar3) * 4);
