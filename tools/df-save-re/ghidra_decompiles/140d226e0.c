// FUN_140d226e0 @ 140d226e0
// callees:


uint FUN_140d226e0(longlong param_1,short param_2,short param_3,short param_4)

{
  ...
  if (((((-1 < param_2) && ((int)param_2 < *(int *)(param_1 + 0x1160e4))) && (-1 < param_3)) &&
    ...
    return *(uint *)(lVar1 + 0x294 + ((longlong)(short)uVar3 * 0x10 + (longlong)(short)uVar2) * 4) &
           0x70;
  }
  return 0;
}
