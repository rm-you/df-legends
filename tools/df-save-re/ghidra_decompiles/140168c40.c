// FUN_140168c40 @ 140168c40
// callees:


undefined4 FUN_140168c40(longlong param_1,short param_2,short param_3,short param_4)

{
  ...
  if (((((-1 < param_2) && ((int)param_2 < *(int *)(param_1 + 0x1160e4))) && (-1 < param_3)) &&
    ...
    return *(undefined4 *)(lVar1 + 0xb94 + ((longlong)(int)uVar3 * 0x10 + (longlong)(int)uVar2) * 4)
    ;
  }
  return 0;
}
