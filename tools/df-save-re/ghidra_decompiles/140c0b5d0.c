...
void FUN_140c0b5d0(longlong param_1,ulonglong *param_2)

{
  ...
  iVar6 = iVar10 + -1;
  if (*(int *)(plVar7[iVar6] + 0x10) < iVar1) {
...
LAB_140c0b72a:
    ...
    do {
      ...
      iVar2 = *(int *)(plVar7[(int)uVar8] + 0x10);
      if (iVar2 == iVar1) {
        return;
      }
      if (iVar5 == iVar6) {
        if (iVar2 < iVar1) goto LAB_140c0b72a;
        if (iVar2 <= iVar1) {
          return;
        }
        plVar7 = plVar7 + iVar5;
    ...
    if (iVar6 < 0) goto LAB_140c0b745;
    if (iVar10 <= iVar6) {
      return;
    }
    uVar9 = (longlong)iVar6 * 8;
    iVar2 = *(int *)(plVar7[iVar6] + 0x10);
    iVar4 = iVar2 - iVar1;
    if (iVar2 < iVar1) {
      if (iVar10 <= iVar6 + 1) {
        return;
