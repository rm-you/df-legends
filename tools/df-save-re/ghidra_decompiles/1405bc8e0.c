...
void FUN_1405bc8e0(undefined8 param_1,undefined8 param_2)

{
  ...
  hFindFile = FindFirstFileA("data/save/*.*",&local_158);
  if (hFindFile != (HANDLE)0xffffffffffffffff) {
        ...
        ((local_158.cFileName[1] != DAT_140edfc19 || (local_158.cFileName[2] != DAT_140edfc1a))))))
    {
      ...
      do {
        lVar3 = lVar2 + 1;
        if (local_158.cFileName[lVar2] != "current"[lVar2]) {
          if (((byte)local_158.dwFileAttributes & 0x10) != 0) {
