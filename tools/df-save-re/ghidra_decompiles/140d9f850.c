// FUN_140d9f850 @ 140d9f850
// callees:
//   -> 14015e420 FUN_14015e420


undefined8 FUN_140d9f850(longlong param_1,short param_2,short param_3,short param_4)

{
      ...
      (((int)param_4 < *(int *)(param_1 + 0x1160ec) && (*(longlong *)(param_1 + 0x1160b0) != 0))))))
  {
    ...
    if (lVar1 != 0) {
      ...
      uVar2 = FUN_14015e420(lVar1,uVar4 & 0xffff,uVar3);
      return uVar2;
    }
  }
  return 1;
