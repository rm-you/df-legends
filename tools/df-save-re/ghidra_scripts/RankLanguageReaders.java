// Ghidra postScript: rank all language_name reader callers by primitive read count.
//@category DF
...
public class RankLanguageReaders extends GhidraScript {
    static class Row {
        Function fn;
        int primitiveRefs;
        int languageRefs;
    ...
    public void run() throws Exception {
        ...
        collect(toAddr("1405bba90"), rows, "primitive");
        collect(toAddr("140c01860"), rows, "language");
        collect(toAddr("140002380"), rows, "flag");
        ...
        println("language_name caller ranking:");
