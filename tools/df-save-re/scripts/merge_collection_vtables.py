#!/usr/bin/env python3
"""Merge collection_vtables_extra.json into collection_vtables.json by tag."""
...
def main() -> None:
    base_path = DECOMPILES / "collection_vtables.json"
    extra_path = DECOMPILES / "collection_vtables_extra.json"
