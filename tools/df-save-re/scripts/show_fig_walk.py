...
print("ok", result.ok, "parsed", result.parsed_count, "/", result.present_count)
print("end", hex(result.end_offset), "death", hex(anchor.death_events_offset or 0))
print("error", result.error, result.error_offset)
